    ...
    (function ($, ko) {
        ...
        binding = {
            ...
            init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
                ...
                options = (allBindings.has("tinymceConfig") ? allBindings.get("tinymceConfig") : "default");
                if (typeof options === "string" &&
                    window.tinymceOptions !== undefined &&
                    window.tinymceOptions[options] !== undefined)
                    options = window.tinymceOptions[options];
